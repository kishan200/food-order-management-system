...
<div class="container" align="center" style="font-size: 22px; color: black;"><br> 
     ...
     <p>Manage all your restaurant from here</b></p>
        ...
        <a href="customer.php" class="list-group-item ">custemer view</a>
    	</div>
    </div>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px; color: black;" ><b> YOUR FOOD ORDER LIST</b> </h3>
  ...
  <tbody >
    <tr >
     ...
     <?php 
              ...
              $sql = "SELECT address,contact FROM customer where username='".$row["username"]."'limit 1";
