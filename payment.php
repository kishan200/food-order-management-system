     ...
     $query = "INSERT INTO orders(F_ID, foodname, price,  quantity, order_date, username, R_ID) 
      ...
      if(!$success)
      {
       ...
       <div class="container" align="center" style="font-size: 22px; color: black;"><br> 
            ...
            <p style="font-size: 55"><br><b>Choose your payment</b></h1>
          </div>
        </div>
        <br>
<h1 class="text-center" style="color: black;">Grand Total: &#8377;<?php echo "$gtotal"; ?>/-</h1>
<h4 class="text-center" style="color: black;">including all service charges. (no delivery charges applied)</h4>
<br>
