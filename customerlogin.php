...
<head>
    <title> Guest Login | APNA RESTAURANT' </title>
    <style>
      body{
            color:red;
      }
  ...
  <body style="background-image: url(lemon.jpg); background-repeat: no-repeat; background-size: 100%;" >
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
     ...
     <h1 align="center">Hi Guest,<br> Welcome to <span class="edit"> APNA RESTAURANT' </span></h1>
     <br>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        ...
        <label style="margin-left: 5px "><div class="col-md-12 forgot-pass-content"> <a href="forgot.php" class="forgot-pass">
