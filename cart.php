...
<html>
  ...
  <head>
    <title> Cart | APNA RESTAURANT' </title>
  </head>
...
{
  ?>
  <div class="container" align="center" style="font-size: 50px; color: black;"><br> 
...
if(empty($_SESSION["cart"]))
{
  ...
  <div class="container">
        ...
        <h1 style="font-size: 55"><b>Your order Cart</b></h1>
        <h2>Oops! We can't smell any food here. Go back and <br> <a href="foodlist.php">order now.</a></h2>
