<html>
  ...
  <head>
    <title> Manager Signup | APNA RESTAURANT' </title>
  </head>
  ...
  <body style="background-image: url(lemon.jpg); background-repeat: no-repeat; background-size: 100%;" >
    ...
    <div class="container">
     ...
     <h1 align="center">Hi Manager, <br> Welcome to <span class="edit"> APNA RESTAURANT' </span></h1>
     <br>
   <h3 align="center" style="color: black">Get started by creating your account</h3>
    </div>
    </div>
