...
<div class="container" align="center" style="font-size: 22px; color: black;"><br> 
     ...
     <p>Manage all your restaurant from here</b></p>
        ...
        <a href="view_order_details.php" class="list-group-item ">View Order Details</a>
         <a href="ShowFeedback.php" class="list-group-item active">Show Feedback</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px; color: black;"> YOUR FEEDBACK  </h3>
